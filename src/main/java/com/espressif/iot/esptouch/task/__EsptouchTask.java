...
import com.espressif.iot.esptouch.util.Log;
...
public class __EsptouchTask implements __IEsptouchTask {
    ...
    public __EsptouchTask(TouchData apSsid, TouchData apBssid, TouchData apPassword,
...
//                        + mApPassword);
    ...
    public List<IEsptouchResult> executeForResults(int expectTaskResultCount)
        ...
        InetAddress localInetAddress = TouchNetUtil.getLocalInetAddress();
